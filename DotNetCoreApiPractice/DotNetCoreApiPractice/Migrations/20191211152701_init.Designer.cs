...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.Course", b =>
                {
                    b.HasOne("DotNetCoreApiPractice.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.CourseInstructor", b =>
                {
                    b.HasOne("DotNetCoreApiPractice.Models.Course", "Course")
                    ...
                    b.HasOne("DotNetCoreApiPractice.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("DotNetCoreApiPractice.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("DotNetCoreApiPractice.Models.OfficeAssignment", b =>
                {
                    b.HasOne("DotNetCoreApiPractice.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("DotNetCoreApiPractice.Models.OfficeAssignment", "InstructorId")
